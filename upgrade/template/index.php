...
<body>
<div class="header"><div>PHPCMS V9 升级程序</div></div>
<div class="container">
	<ul class="guild">
...
<thead>
  <tr>
    ...
    <td><span>介绍</span></td>
    <td width="80"><span>开始升级</span></td>
  </tr>
</thead>
<tbody>
  <tr>
    <td><?php echo $configs['from_version'].'&nbsp;&nbsp;'.$configs['from_release']?></td>
    <td><?php echo $configs['to_version'].'&nbsp;&nbsp;'.$configs['to_release']?></td>
...
<thead>
  <tr>
    <td width="150"><span class="success">请等待，程序正在升级中...</span></td>
  </tr>
</thead>
</table>
<script type="text/javascript">
...
<?php elseif ($op == 'version'):?>
    <div class="help">
    	<h5>升级完成 </h5>
        <span style="color:red">1.升级完成后，请到后台更新缓存。<br />
       2.升级完成后，请删除补丁升级程序。</span>
    </div>
    <table class="list" width="100%">
<thead>
  <tr>
    <td width="150"><span><a href="<?php echo APP_PATH?>admin.php" style="font-weight:bold">恭喜您，升级成功！点此进入后台，记得更新缓存哟。</a></span></td>
  </tr>
</thead>
</table>
<?php endif;?>
