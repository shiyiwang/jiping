...
<div class="main w_1000 o_a">
    ...
    <div class="col_sub f_l">
        ...
        <h2 class="bg"><span class="txt"><?php echo $CATEGORYS[$catid]['catname'];?></span><span class="english"><?php echo $CATEGORYS['32']['description'];?></span></h2>
            <ul class="list">
            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"get\" data=\"op=get&tag_md5=ce96e58dc0d8f0382d943e8b6f9ee80a&sql=SELECT+title%2Curl+FROM+ji_news+WHERE+catid%3D%24catid&cache=%273600&num=5&return=latestarr\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}pc_base::load_sys_class("get_model", "model", 0);$get_db = new get_model();$r = $get_db->sql_query("SELECT title,url FROM ji_news WHERE catid=$catid LIMIT 5");while(($s = $get_db->fetch_next()) != false) {$a[] = $s;}$latestarr = $a;unset($a);?>
           
                <?php $n=1;if(is_array($latestarr)) foreach($latestarr AS $hiring) { ?>
                <li><a href="<?php echo $hiring['url'];?>" title="<?php echo $hiring['title'];?>"><?php echo $hiring['title'];?></a></li>
                <?php $n++;}unset($n); ?>  
    ...
    <div class="col_main f_r">
    	<div class="position bg_x"><span class="ico ico_home"></span><span class="link">您已经浏览到：<a href="/" title="">首页</a> &gt; <span class="now"><?php echo $CATEGORYS[$catid]['catname'];?></span></span></div>
        <div class="main_content">
        	<div class="hiring">
                ...
                <div class="hiring_box">
                	<div class="hd bg_x"><span class="f_r">发布时间</span><span>招聘职位</span></div>
                    <div class="bd">
                      ...
                      <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=11e982198282a77f17ebf8d7a1dede5e&action=lists&catid=%24catid&num=10&order=id+DESC&page=%24page\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$pagesize = 10;$page = intval($page) ? intval($page) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$content_total = $content_tag->count(array('catid'=>$catid,'order'=>'id DESC','limit'=>$offset.",".$pagesize,'action'=>'lists',));$pages = pages($content_total, $page, $pagesize, $urlrule);$data = $content_tag->lists(array('catid'=>$catid,'order'=>'id DESC','limit'=>$offset.",".$pagesize,'action'=>'lists',));}?> 
                          ...
                          <li><span class="f_r"><?php echo date("Y-m-d",$r['inputtime']);?></span><a href="<?php echo $r['url'];?>" title=""><?php echo $r['title'];?></a></li>
