...
<div class="main w_1000 o_a">
    ...
    <div class="col_sub f_l">
    	<div class="sidebar">
        	<h2 class="bg"><span class="txt"><?php echo $CATEGORYS[$parentid]['catname'];?></span><span class="english">
            <?php if($catid==31) { ?>
            	<?php echo $CATEGORYS['27']['description'];?>
            <?php } else { ?>
            	<?php echo $CATEGORYS['6']['description'];?>
            <?php } ?>
            
            </span></h2>
            <ul class="list">
            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"get\" data=\"op=get&tag_md5=cd037548beb12c3855c4605fac4c8051&sql=SELECT+arrchildid+FROM+ji_category+WHERE+catid%3D%24parentid&cache=%273600&return=catarr\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}pc_base::load_sys_class("get_model", "model", 0);$get_db = new get_model();$r = $get_db->sql_query("SELECT arrchildid FROM ji_category WHERE catid=$parentid LIMIT 20");while(($s = $get_db->fetch_next()) != false) {$a[] = $s;}$catarr = $a;unset($a);?>
    ...
    <div class="col_main f_r">
    	<div class="position bg_x"><span class="ico ico_home"></span><span class="link">您已经浏览到：<a href="/" title="">首页</a> &gt; <span class="link"><a href="<?php echo $CATEGORYS[$parentid]['url'];?>" title="<?php echo $CATEGORYS[$parentid]['catname'];?>"><?php echo $CATEGORYS[$parentid]['catname'];?></a></span>&nbsp;&gt; <span class="now"><?php echo $CATEGORYS[$catid]['catname'];?></span></span></div>
