...
<div class="main w_1000 o_a">
    ...
    <div class="col_sub f_l">
    	<div class="sidebar">
        	<h2 class="bg"><span class="txt"><?php echo $CATEGORYS[$parentid]['catname'];?></span><span class="english">about jiping</span></h2>
            <ul class="list">
    ...
    <div class="col_main f_r">
    	<div class="position bg_x"><span class="ico ico_home"></span><span class="link">您已经浏览到：<a href="/" title="">首页</a> &gt;<span class="link"><a href="<?php echo $CATEGORYS['28']['url'];?>" title="<?php echo $CATEGORYS[$parentid]['catname'];?>"><?php echo $CATEGORYS[$parentid]['catname'];?></a></span>&nbsp;&gt; <span class="now"><?php echo $CATEGORYS[$catid]['catname'];?></span></span></div>
