...
<div class="main w_1000 o_a">
   <!--左栏 start-->
    ...
    <div class="col_main f_r">
    	<div class="position bg_x"><span class="ico ico_home"></span><span class="link">您已经浏览到：<a href="/" title="">首页</a> &gt;  <span class="now">产品搜索</span></span></div>
        <div class="main_content">
            ...
            <div class="pro_list">
                ...
                <?php $n=1; if(is_array($data)) foreach($data AS $i => $r) { ?>
                	...
                	<li class="item hot_sales"><?php $img_thumb_url=thumb($r['thumb'],150,150);?>
                ...
                <?php $n++;}unset($n); ?>
                <?php if(empty($data)) { ?>抱歉，暂时还没有查询结果！<?php } ?>
                </ul>
