...
<p class="cp">Powered by <strong><a href="http://www.szjiping.com" target="_blank">吉平化工</a></strong> <em></em> &copy; <?php echo date('Y', SYS_TIME);?> <img src="<?php echo IMG_PATH;?>copyright.gif"/>
</p>
</div>
</body>
</html>